defmodule PlayerStats.Stats.RushingStats do
  ...
  def changeset(rushing_stats, attrs) do
    rushing_stats
    |> cast(attrs, [:player, :team, :position, :attempts, :attempts_game, :yards, :yards_avg, :yards_game, :touchdowns, :longest, :longest_td, :first_downs, :first_down_pc, :yards_20, :yards_40, :fumbles])
    |> validate_required([:player, :team, :position, :attempts, :attempts_game, :yards, :yards_avg, :yards_game, :touchdowns, :longest, :longest_td, :first_downs, :first_down_pc, :yards_20, :yards_40, :fumbles])
  end
end
